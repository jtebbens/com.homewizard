      ...
      .then(async () => {
        ...
        if (data.energy_import_kwh === undefined) {
          if (this.getCapabilityValue('meter_power') != data.energy_import_t1_kwh + data.energy_import_t2_kwh - (data.energy_export_t1_kwh + data.energy_export_t2_kwh)) {
            promises.push(
              this.setCapabilityValue('meter_power', data.energy_import_t1_kwh + data.energy_import_t2_kwh - (data.energy_export_t1_kwh + data.energy_export_t2_kwh)).catch(this.error),
            );
          }
        }
