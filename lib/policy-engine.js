...
_mapPolicyToHwMode(policyMode, ctx) {
   ...
   */
  buildPlanningSchedule(slots, pvForecast, minDischargePriceOverride = null, battChargePowerW = 800, maxChargePriceOverride = null, batteryCapacityKwhOverride = null) {
   ...
   */
  _mapActionToHwModeForPlanning(action, { price, soc, pvW, consumptionW = 0, tariffType, userPolicyMode, maxChargePrice, minDischargePrice, minSoc, maxSoc, futurePrices, battChargePowerW = 800, pvStoreValue = null, exportPrice = null }) {
