...
class OptimizationEngine {
  ...
  _runBackwardDP(N, prices, pvCoverage, consumptionWPerSlot, slotH,
    ...
    //
    // When strong PV is expected tomorrow, the battery will be recharged for free regardless
    // of current SoC. Holding energy overnight then has lower marginal value — PV will replenish
    // it anyway, so the optimizer should prefer discharging tonight even at sub-break-even prices.
    // Discount scales linearly with pvKwhTomorrow / capacityKwh, up to 90% at full PV day.
