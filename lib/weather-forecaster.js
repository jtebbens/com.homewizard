...
class WeatherForecaster {
  ...
  async fetchForecast(latitude, longitude, tilt = null, azimuth = null) {
    ...
    try {
      ...
      const url = this._buildApiUrl(lat, lon, tilt, azimuth);
   ...
   * @private
   */
  _buildApiUrl(latitude, longitude, tilt = null, azimuth = null) {
    ...
    const radiationVar = useTilted ? 'global_tilted_irradiance' : 'shortwave_radiation';

    const params = new URLSearchParams({
      latitude: latitude.toString(),
      longitude: longitude.toString(),
      hourly: `sunshine_duration,temperature_2m,cloud_cover,precipitation_probability,weather_code,${radiationVar}`,
