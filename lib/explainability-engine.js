...
class ExplainabilityEngine {
  ...
  generateExplanation(recommendation, inputs, scores) {
    ...
    // ✅ FIX: Always use configured battery efficiency (0.75 RTE), not learned
    // Learned efficiency can drift to 99% due to measurement errors
    const configuredEff = settings.battery_efficiency || 0.75;
    inputs.batteryEfficiency = configuredEff;
    ...
    return {
      ...
      batteryEfficiency: configuredEff,
