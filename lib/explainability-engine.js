    ...
    if (gridPower < -150) {
      ...
      if (_exportWins) {
        ...
        reasons.push({
          icon: '⚡',
          category: 'pv',
          text: `PV-overschot (${exportPower}W export) — export naar net winstgevender (€${_exportVal.toFixed(3)} > €${_maxFuture.toFixed(3)} × ${_eff.toFixed(2)} − cycluskosten €${_cycleCost.toFixed(3)} = €${_storeValue.toFixed(3)})${delayNote}.`,
          impact: 'high',
          sentiment: 'positive',
          supportedMode: 'preserve'
        });
