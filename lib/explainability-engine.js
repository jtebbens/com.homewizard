...
class ExplainabilityEngine {
  ...
  _addPVReasons(reasons, inputs) {
    ...
    if (gridPower < -150) {
      ...
      // Export value of this surplus now — retail under saldering, lower per-slot
      // exportPrice under asymmetric_2027 — so the reason matches the DP/runtime store-vs-export.
      const _exportVal = _price === null ? null : exportValue(
