 ...
 * ENTSOE direct API with Gruijter fallback). Used when PBTH is unavailable
 * (or incomplete) in MergedPriceProvider.
 *
 * Data is 15-min EUR/MWh spot. This provider applies markup + BTW to produce
 * final retail prices, same as pbth-provider's slots already arrive as.
 */
